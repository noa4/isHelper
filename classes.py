...
class Exigence:
    ...
    def __init__(self, idex, intitule, critere, espece = 0,niveau=None, exigence_mere =0):
        self.idex = idex
    ...
    def __str__(self):
        ...
        return "L'exigence N{} {} est une exigence {} d'intitulé {} ".format(self.idex, self.critere, espece, self.intitule)
